...
# Input : Datset with related information
# Output : Dataset after splitting
# Author : Kaustubh Nitin Wani
# # Date : 09/08/2025
###########################################################

def split_datset(dataset, train_percentage, feature_headers,target_header,random_state = 42):
...
def main():
    # 1. Ensure CSVexists(run once if needed)
    data_file_to_csv()
    ...
    target_header = 'CancerType'
    #target_header = HEADERS[1:-1] # CancerType (2=benign, 4=malignant)
    ...
    # 6. Split
    train_x,test_x,train_y,test_y = split_datset(dataset,0.7,feature_headers,target_header)
